...
import { ListTodo, Package, LucideAreaChart, Trophy } from "lucide-react";
...
export default function Dashboard() {
  ...
  return (
    <AppShell pageTitle="Analytics Dashboard">
      {/* Welcome Section */}
      <div className="mb-6">
        ...
        {loading ? (
          ...
          <>
            ...
            <KpiCard
              ...
              icon={
                <span className="text-xl p-0 text-yellow-400">
                  <Trophy />
                </span>
              }
            />
                    ...
                    <TableHeader>
                      <TableRow className="border-b border-gray-200 hover:bg-transparent">
                        {(activeView === "purchase"
                          ...
                          <TableHead
                            key={column.key}
                            className={`py-3 px-4 text-gray-600 font-medium text-xs whitespace-nowrap bg-gray-50/50 ${
                              [
                                "pickupQty",
                                "buyRate",
                                "buyAmount",
                      ...
                      {loading ? (
                        ...
                        transportData.map((transaction, index) => (
                          ...
                          >
                            {activeView === "purchase" ? (
                              <>
                                <TableCell className="py-2.5 px-4 text-gray-600 text-xs whitespace-nowrap">
                                  {index + 1}
                                </TableCell>
                                <TableCell className="py-2.5 px-4 text-gray-600 text-xs whitespace-nowrap">
                                ...
                                <TableCell className="py-2.5 px-4 text-gray-600 text-xs text-right whitespace-nowrap font-medium">
                              ...
                              <>
                                ...
                                <TableCell className="py-2.5 px-4 text-gray-700 text-xs text-right bg-amber-50/50 font-semibold whitespace-nowrap">
